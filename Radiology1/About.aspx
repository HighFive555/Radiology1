<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="Radiology1.About" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <table class="nav-justified" style="border: 1px double #FFFFFF; width: 114%; height: 493px; margin-right: 69px">
        <tr>
            ...
            <td class="text-left" style="border-style: double; border-color: #A1CAE9; padding: 0px; height: 4px; width: 453px;">
                <asp:TextBox ID="TextBox1" runat="server" BackColor="#F7F6F3" BorderStyle="None" Height="25px" Width="193px"></asp:TextBox>
&nbsp;&nbsp;&nbsp;<asp:Button ID="Button9" runat="server" OnClick="Button9_Click" Text="Search" />
        ...
        <tr>
            ...
            <td class="text-left" style="background-color: #F7F6F3; width: 1435px;" rowspan="9">
                <asp:Image ID="Image3" runat="server" BorderColor="#627A96" BorderStyle="Groove" BorderWidth="5px" Height="366px" style="margin-right: 0px; margin-top: 0px" Width="453px" />
            </td>
            <td class="text-left" style="background-color: #F7F6F3; height: 33px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</td>
            <td class="text-left" style="background-color: #F7F6F3" rowspan="9">
                <asp:TextBox ID="TextBox13" runat="server" Height="367px" Width="406px" BorderColor="#627A96" BorderStyle="Groove" BorderWidth="6px"></asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="background-color: #F7F6F3; width: 534px;">&nbsp;</td>
            <td style="background-color: #F7F6F3; width: 1435px;" class="text-left"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong>&nbsp;&nbsp;</td>
            <td style="background-color: #F7F6F3; color: #627A96; font-size: large;" class="text-center">&nbsp;</td>
            <td style="background-color: #F7F6F3; color: #627A96; font-size: large;" class="text-center"><strong>Comments</strong></td>
            <td>&nbsp;</td>
        </tr>
        <tr>
